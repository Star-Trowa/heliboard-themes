...
| Theme                      | Preview                                                        | Style                                                                      |
| -------------------------- | -------------------------------------------------------------- | -------------------------------------------------------------------------- |
| **After Colony**           | ![AfterColony](previews/AfterColony.jpg)<br>![AfterColony(Gesture)](previews/AfterColony(Gesture).jpg) | Pure black background, white keys, magenta/pink number accents, cyan globe and delete button, purple search button. <br>The contrast is immaculate.                                                                                                             |
| **AfterColonyZero**            | ![AfterColonyZero](previews/AfterColonyZero.jpg)                                                       | If you want to use your own backgrounds, use this one. Just dim/overlay your bg by 35%-50% and it works. |
...
| **Catppuccin Frappe**      | ![Catppuccin Frappe](previews/Catpuccin-frappe.png)            | Muted blue-grey, mauve search button, faithful to the Catppuccin palette   |
| **Dark Mellow**            | ![Dark Mellow](previews/DarkMellow.png)                        | Near-black with warm undertones, pink search button, very clean            |
| **Dark Vesnea**            | ![Dark Vesnea](previews/DarkVesnea.png)                        | Deep purple-navy, barely-visible pink number accents, night-mode friendly  |
| **Vesnea D**               | ![Vesnea D](previews/Vesnea-D.png)                             | Dark Vesnea variant with adjusted contrast                                 |
| **Vesnea L**               | ![Vesnea L](previews/Vesnea-L.png)                             | Light Vesnea — warm sandy spacebar, soft and charming                      |
| **Iridium Light**          | ![Iridium Light](previews/Iridium(Light).png)                  | Pure minimal grey — disappears while you type                              |
| **wth**                    | ![wth](previews/wth.png)                                       | Dark navy, neon cyan keys, magenta accents, hot pink toolbar  |
